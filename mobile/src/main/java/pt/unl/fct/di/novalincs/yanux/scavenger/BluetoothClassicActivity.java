...
import pt.unl.fct.di.novalincs.yanux.scavenger.common.bluetooth.classic.BluetoothClassicCollector;

public class BluetoothClassicActivity extends AppCompatActivity {

    private BluetoothClassicCollector bluetoothClassicCollector;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bluetoothClassicCollector = new BluetoothClassicCollector(this);
            ...
            public void onReceive(Context context, Intent intent) {
                switch (intent.getAction()) {
                    ...
                    case BluetoothAdapter.ACTION_DISCOVERY_FINISHED:
                        ...
                        bluetoothDiscoveryElapsedTime.setText((System.nanoTime() - bluetoothClassicCollector.getDiscoveryStartTime()) / (1000 * 1000) + " ms");
                        bluetoothClassicCollector.startDiscovery();
                        break;
                    default:
                        break;
                }
        ...
        bluetoothClassicCollector.startDiscovery(broadcastReceiver);
        if (!bluetoothClassicCollector.isEnabled()) {
            BluetoothClassicCollector.enableBluetooth(this);
        }

        TextView bluetoothName = (TextView) findViewById(R.id.bluetooth_name);
        bluetoothName.setText(bluetoothClassicCollector.getName());

        TextView bluetoothAddress = (TextView) findViewById(R.id.bluetooth_address);
        bluetoothAddress.setText(bluetoothClassicCollector.getAddress());
    }
    ...
    protected void onPause() {
        super.onPause();
        bluetoothClassicCollector.cancelDiscovery(broadcastReceiver);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case BluetoothClassicCollector.REQUEST_CODE_ENABLE_BLUETOOTH:
                ...
                break;
            case BluetoothClassicCollector.REQUEST_CODE_ENABLE_BLUETOOTH_DISCOVERABILITY:
