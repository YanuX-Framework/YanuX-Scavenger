...
public class NearbyMessagesActivity extends AppCompatActivity {
     ...
     *
     * It is also worth mentioning that you can use the Google YanuxBrokerBeacon Tools app
     * (https://play.google.com/store/apps/details?id=com.google.android.apps.location.beacon.beacontools)
     * and the Google YanuxBrokerBeacon Platform Dashboard (https://developers.google.com/beacons/dashboard/)
     * to register and manage beacons in the Google Cloud Platform ecosystem, which also include the
     * Google Proximity YanuxBrokerBeacon API: https://developers.google.com/beacons/proximity/guides
     *
