...
public class LinearChirpToneGenerator {
    private LinearChirpWavePCM16Bit wave;
    private AudioTrack currentAudioTrack;

    public LinearChirpToneGenerator() {
        this.wave = new LinearChirpWavePCM16Bit();
    }

    public double getFrequency0() {
        return wave.getStartFrequency();
    }

    public void setFrequency0(double frequency) {
        if (currentAudioTrack != null) {
            currentAudioTrack.flush();
        }
        wave.setStartFrequency(frequency);
    }

    public double getFrequency1() {
        return wave.getFinalFrequency();
    }
    ...
    public void setFrequency1(double frequency) {
        ...
        wave.setFinalFrequency(frequency);
    }
